...
#### Day 2
- Added an *explosion sound*. I already had a rocket sound from my Marslander game, but I needed an explosion. I searched for an algorithm but wasn't satisfied with what I found but finally discovered that simply adding a [lowpass filter and ramp](https://bacionejs.github.io/explosion) did the trick 🕵️‍♂️
